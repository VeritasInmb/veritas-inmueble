...
export const WarningIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg width="24" height="24" className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
);
...
export const CloseIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg width="24" height="24" className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path></svg>
);
...
export const CheckCircleIcon: React.FC<{ className?: string }> = ({ className }) => (
    // FIX: Added a space in the 'd' attribute of the path from "11-18" to "11 -18" to prevent a JSX parsing error.
    <svg width="24" height="24" className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11 -18 0 9 9 0 0118 0z"></path></svg>
);

export const SpinnerIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg width="24" height="24" className={`animate-spin ${className}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
export const InboxIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg width="24" height="24" className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 13.5h3.86a2.25 2.25 0 0 1 2.012 1.244l.256.512a2.25 2.25 0 0 0 2.013 1.244h3.218a2.25 2.25 0 0 0 2.013-1.244l.256-.512a2.25 2.25 0 0 1 2.013-1.244h3.859M12 3v18.75m9-9.375v3.375c0 .621-.504 1.125-1.125 1.125H3.375c-.621 0-1.125-.504-1.125-1.125V12c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125Z" />
    </svg>
);
